        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <CodeBlock path="curl" content={`curl -X POST http://your-server:8090/v1/responses \\
  ...
  -d '{
    ...
    "stream": true
            ...
            <div>
              ...
              <CodeBlock path="curl" content={`curl -X POST http://your-server:8090/v1/chat/completions \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d '{
    "model": "gpt-5.4",
    ...
    "stream": true
            ...
            <div>
              ...
              <CodeBlock path="curl" content={`curl -X POST http://your-server:8090/v1/messages \\
